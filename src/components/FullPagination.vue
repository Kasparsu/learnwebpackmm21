<template>
  ...
  <ul class="pagination-list">
    ...
    <li v-if="current>1"><a class="pagination-link" :aria-label="'Goto page ' + current-1">{{current-1}}</a></li>
    ...
    <li v-if="current<info.pages-1"><a class="pagination-link" :aria-label="'Goto page ' + info.pages" @click="$emit('goToPage', info.pages)">{{info.pages}}</a></li>
  </ul>
</nav>
</template>
